...
def create_recipe(user, **params):
    ...
    defaults = {
        ...
        'link': 'http://example.com/recipe.gif'
    }
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_ingredents(self):
    ...
    def clear_recipe_ingerdients(self):
        """Test clearing a recipe ingredients."""
        ingredeint = Ingredient.objects.create(user=self.user, name='Garlic')
        recipe = create_recipe(user=self.user)
        recipe.ingredients.add(ingredeint)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Aubegrine')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Potatoes cheese')
...
class ImageUploadTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(email="user@example.com", password='123')
        self.client.force_authenticate(self.user)
