...
def create_user(email='user@example.com', password='123'):
...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_update_ingredients(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Clitanto')
    ...
    def test_delete_tag(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Kim')
